...
int main(void) {
    ...
    ((int64_t []){1,2,3}), sizeof(((int64_t []){1,2,3})) / sizeof(((int64_t []){1,2,3})[0])

  Array xs = array_init(((int []){1, 2, 3, 4, 5}), sizeof(((int []){1, 2, 3, 4, 5})) / sizeof(((int []){1, 2, 3, 4, 5})[0]));
  array_print(&xs);
  Array ys = array_new(((int [10]){0}), 10);
  array_print(&ys);
